...
@section('content')
    <section class="h-screen flex flex-row">
        ...
        <main class="p-[20px] h-full w-full relative">
            <form class="w-64" method="POST" action="">
                @csrf
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="tema" id="tema" class="bg-slate-5 border borderslatey2000 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-slate-50 dark:border-slate-200 dark:placeholder-gray-400 dark:text-primary dark:focus:ring-blue-500 dark:focus:border-blue-500"required="">
                </div>
                <div>
                    <label for="pemateri" class="block mt-2 mb-2 text-sm font-medium text-gray-900 dark:text-primary">Pemateri</label>
                    <input type="text" name="pemateri" id="pemateri" class="bg-slate-5 border borderslatey2000 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-slate-50 dark:border-slate-200 dark:placeholder-gray-400 dark:text-primary dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                </div>
                <div>
                    <label for="waktu" class="block mt-2 mb-2 text-sm font-medium text-gray-900 dark:text-primary">Waktu</label>
                    <input type="time" name="waktu" id="waktu" class="bg-slate-5 border borderslatey2000 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-slate-50 dark:border-slate-200 dark:placeholder-gray-400 dark:text-primary dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                </div>
                <div>
